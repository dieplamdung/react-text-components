  ...
  return /*#__PURE__*/_jsxs(Box, {
    ...
    children: [/*#__PURE__*/_jsx(Container, {
      ...
      children: /*#__PURE__*/_jsxs(Box, {
        ...
        }), !!listThumbnail?.length && listThumbnail?.length > 3 && /*#__PURE__*/_jsx(Box, {
          sx: {
            display: 'flex',
            alignItems: 'center'
          },
          children: /*#__PURE__*/_jsx(Box, {
            children: viewMore?.title && /*#__PURE__*/_jsx(Box, {
      ...
      children: /*#__PURE__*/_jsxs(Box, {
        ...
        children: [!!dataItem?.length && dataItem.map((item, index) => /*#__PURE__*/_jsx(Box, {
          sx: {
            display: "inline-block",
