...
const Search = /*#__PURE__*/forwardRef((props, ref) => {
  ...
  useEffect(() => {
    ...
    if (typeof window !== "undefined") {
      disableScrollBody(isShowSearch ?? false);
    }
        ...
        if (event.keyCode === 13 || event.key === 'Enter') {
          ...
          refTimeOut.current = setTimeout(() => {
            if (valueSearch && isInputFocus) {
              const recentInLocal = JSON.parse(localStorage.getItem(RECENT_LOCAL)) ?? [];
        ...
        children: /*#__PURE__*/_jsxs(Box, {
          ...
          children: [/*#__PURE__*/_jsx(Logo, {
            ...
            children: /*#__PURE__*/_jsxs(Box, {
              ...
              children: [isShowSearch && props?.children, !!valueSearch && /*#__PURE__*/_jsx(Box, {
                sx: {
                  position: "absolute",
                  top: "50%",
                  right: "0%",
