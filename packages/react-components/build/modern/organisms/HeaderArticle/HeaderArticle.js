...
const HeaderArticle = props => {
  ...
  const hadTagDownload = useMemo(() => {
    const titleTagList = tags?.map(item => item.title) ?? [];
    const result = titleTagList?.includes("DOWNLOADS") || titleTagList?.includes("DOWNLOAD") || titleTagList?.includes("download") || titleTagList?.includes("downloads");
    return result;
  }, [tags]);
  ...
  const handleDownload = async () => {
    ...
    try {
      ...
      if (wrapper) {
        ...
        const lengthListImg = listImg?.length ?? 0;
        ...
        if (lengthListImg) {
          ...
          for (let i = 0; i < lengthListImg; i += 1) {
            ...
            img?.file(arrName[lengthArrName], data, {
              base64: true
            });
          }
    ...
    children: [/*#__PURE__*/_jsx(Container, {
      ...
      children: /*#__PURE__*/_jsx(Box, {
        ...
        children: /*#__PURE__*/_jsxs(Box, {
          children: [!!tags && !!tags?.length && tags.map((tag, idx) => /*#__PURE__*/_jsx(Box, {
            sx: {
            ...
            sx: {
              display: 'flex',
              justifyContent: date?.value ? 'space-between' : 'flex-end',
              alignItems: layoutBlog ? 'center' : 'end'
            },
            children: [date?.value && !layoutBlog && /*#__PURE__*/_jsxs(Box, {
              children: [/*#__PURE__*/_jsx(Typography, {
                variant: "l2",
                color: colors.otherColor.silver,
                children: date?.text && (date?.text ?? '').toUpperCase()
              }), /*#__PURE__*/_jsx(Box, {
                children: /*#__PURE__*/_jsx(Typography, {
                  variant: "p5",
                  color: colors.otherColor.silver,
              ...
              children: [/*#__PURE__*/_jsx(Box, {
                ...
                children: [userInfo?.name && /*#__PURE__*/_jsx(Typography, {
                  variant: 'p7',
                ...
                }), userInfo?.position && /*#__PURE__*/_jsx(Box, {
                  sx: {
                    '& p': {
                      fontSize: '12px',
                      lineHeight: '18px'
            ...
            children: [(!!store?.url || !!store?.title) && !!timeRange && !isProtect && /*#__PURE__*/_jsxs(Box, {
              sx: {
                marginTop: "32px",
                display: "flex",
                flexDirection: "column",
