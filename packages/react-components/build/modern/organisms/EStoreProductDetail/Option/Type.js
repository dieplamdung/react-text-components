...
function Type(props) {
  ...
  return /*#__PURE__*/_jsxs(Box, {
    ...
    children: [WrapperContainer( /*#__PURE__*/_jsx(Typography, {
      ...
      children: !!typeList?.length && typeList.map((item, index) => {
        return /*#__PURE__*/_jsx(Box, {
          sx: {
            padding: "12.5px 32px",
            border: "1px solid",
            borderRadius: "40px",
            borderColor: itemSelectType?.id === item?.id ? colors.secondary.bandaiNamcoBlue : colors.neutral.neutral5,
            cursor: "pointer",
            transition: "all 0.3s",
            "&:hover": {
          ...
          children: /*#__PURE__*/_jsx(Typography, {
            ...
            sx: {
              ...
              fontWeight: "600",
              color: itemSelectType?.id === item?.id ? colors.secondary.bandaiNamcoBlue : colors.primary.bandaiNamcoBlack
            },
            children: item?.titleType
          })
        }, index);
      })
    })]
