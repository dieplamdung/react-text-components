...
export default function Edition(props) {
  ...
  return /*#__PURE__*/_jsxs(Box, {
    ...
    children: [WrapperContainer( /*#__PURE__*/_jsxs(Box, {
      ...
      ref: refWrapper,
      children: [!!editionList?.length && editionList.map((item, index) => {
          ...
          children: /*#__PURE__*/_jsx(Box, {
            ...
            children: /*#__PURE__*/_jsxs(Box, {
              sx: {
                ...
                border: "1px solid",
                borderRadius: "10px",
                borderColor: itemSelectEdition?.id === item?.id ? colors.secondary.bandaiNamcoBlue : colors.neutral.neutral5,
                cursor: "pointer",
                transition: "all 0.3s",
                "&:hover": {
              ...
              children: [/*#__PURE__*/_jsx(Typography, {
                variant: "p5",
                color: itemSelectEdition?.id === item?.id ? colors.secondary.bandaiNamcoBlue : colors.primary.bandaiNamcoBlack,
                sx: {
                  lineHeight: {
                    xs: "20px",
                    lg: "22px"
                ...
                children: item?.titleEdition
              }), /*#__PURE__*/_jsx(Typography, {
                variant: "p6",
                color: itemSelectEdition?.id === item?.id ? colors.secondary.bandaiNamcoBlue : "#9F9F9F",
                sx: {
                  lineHeight: {
                    xs: "20px",
                    lg: "22px"
