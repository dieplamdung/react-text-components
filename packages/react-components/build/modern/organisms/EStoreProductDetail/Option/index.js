  ...
  return /*#__PURE__*/_jsxs(Box, {
    ...
    children: [WrapperContainer( /*#__PURE__*/_jsxs(React.Fragment, {
      ...
      children: [WrapperContainer( /*#__PURE__*/_jsx(Typography, {
        ...
        ref: refWrapper,
        children: [!!platform?.platformList?.length && platform?.platformList.map((item, index) => {
          return /*#__PURE__*/_jsx(Box, {
            ...
            children: /*#__PURE__*/_jsx(Box, {
              ...
              children: /*#__PURE__*/_jsx(Platform, {
                isSelect: itemPlatformSelect?.id === item?.id,
      ...
      children: /*#__PURE__*/_jsx(Type, _extends({}, typeOption, {
        padding: padding,
        isDisable: !itemPlatformSelect?.id,
      ...
      children: [/*#__PURE__*/_jsxs(Box, {
        ...
        children: [/*#__PURE__*/_jsx(Box, {
          sx: {
            opacity: !itemPlatformSelect?.id ? "0.4" : "1",
            pointerEvents: !itemPlatformSelect?.id ? "none" : "auto"
          },
          children: /*#__PURE__*/_jsx(DropdownQuantity, {
            maxQuantity: maxQuantity || 5,
            currentQuantity: quantity ?? 1,
            label: labelQty,
            onSetQuantity: qty => onSelectQty?.(qty)
          })
        }), /*#__PURE__*/_jsx(Typography, {
          variant: "h6",
        ...
        children: !isSelectTypeDigital ? /*#__PURE__*/_jsxs(Box, {
          ...
          children: [/*#__PURE__*/_jsx(Button, _extends({}, buttonPropsAddCart, {
            disabled: !itemPlatformSelect?.id
          })), /*#__PURE__*/_jsx(Button, _extends({}, buttonPropsBuyNow, {
            variant: !itemPlatformSelect?.id ? "primary" : buttonPropsBuyNow?.variant,
            disabled: !itemPlatformSelect?.id
          }))]
