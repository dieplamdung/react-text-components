...
const ScrollingDLCContainer = props => {
  ...
  useEffect(() => {
    ...
    if (isMobileMin && typeof window !== "undefined" && listThumbnail?.length > 3) {
    ...
    children: [/*#__PURE__*/_jsx(Container, {
      ...
      children: /*#__PURE__*/_jsxs(Box, {
        ...
        children: [title && /*#__PURE__*/_jsx(Typography, {
          ...
          children: [!!titleSeeAll && hrefSeeAll && /*#__PURE__*/_jsx(Box, {
            ...
            children: typeof nextLink === 'function' ? nextLink?.(hrefSeeAll || "", /*#__PURE__*/_jsx(Typography, {
              variant: "p5",
              sx: {
      ...
      children: [/*#__PURE__*/_jsxs(Box, {
        sx: {
          ...
          width: "100%",
          height: {
            xs: listThumbnail?.length > 3 ? `${showMore ? totalHeightItem : height3Item}px` : "100%",
            md: "100%"
          },
          overflow: {
            xs: listThumbnail?.length > 3 ? `${showMore ? "auto" : "hidden"}` : "auto",
            md: "scroll"
          },
          transition: "all 0.3s",
      ...
      }), isMobileMin && listThumbnail?.length > 3 && /*#__PURE__*/_jsx(Box, {
        sx: {
          display: "flex",
          justifyContent: "center",
          marginTop: "48px"
