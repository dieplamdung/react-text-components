...
const ImagePopupSlider = props => {
  ...
  */
  ...
  useEffect(() => {
    ...
    if (items) {
      items.forEach(node => {
        node?.querySelector?.('#image-cloned')?.remove();
      });
    }
  }, []);
    ...
    children: /*#__PURE__*/_jsxs(Box, {
      ...
      children: [/*#__PURE__*/_jsx(Box, {
          ...
          children: /*#__PURE__*/_jsxs(Box, {
            ...
            sx: {
              ...
              '& .slick-list': {
                ...
                '& .slick-track': {
                  display: 'flex',
                  alignItems: 'center',
                  justifyContent: screenshotItems !== null && screenshotItems?.length === 1 ? 'center' : 'flex-start',
                  '& .slick-slide': {
                    padding: {
                      xs: '0 4px',
                      md: '0px 12px'
            ...
            children: [/*#__PURE__*/_jsx(Box, {
              ...
              children: /*#__PURE__*/_jsx(Slider, _extends({}, overlaySliderSettings, {
                ...
                children: screenshotItems?.map((screenshotInfo, i) => {
                  return /*#__PURE__*/_jsx(Box, {
                    id: `image-cloned`,
                    sx: {
                    ...
                    children: /*#__PURE__*/_jsx(MediaGalleryCard, {
                      nextImage: screenshotInfo?.mainImageNext,
                      color: colors.primary.bandaiNamcoWhite,
                      hideContent: clicked,
                      description: screenshotInfo?.title,
                      img: screenshotInfo?.mainImage ?? '',
                      icon: screenshotInfo?.icon,
                      iconText: screenshotInfo?.iconText
                    })
                  }, i);
                })
              }))
              ...
              sx: {
                display: clicked ? 'none' : 'inline-block',
                cursor: 'pointer',
                opacity: selectedTrailer + 1 === screenshotItems?.length ? 0 : 1,
                position: 'absolute',
                zIndex: 1099,
        ...
        children: [/*#__PURE__*/_jsxs(Typography, {
          ...
          children: [selectedTrailer + 1, " of ", screenshotItems?.length]
        }), /*#__PURE__*/_jsx(Box, {
