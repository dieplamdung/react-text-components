...
const TemplateDownload = props => {
  ...
  const next = idx => {
    thisSlider.current[idx]?.slickNext();
  };

  const previous = idx => {
    thisSlider.current[idx]?.slickPrev();
  };
  ...
  const handleAfterChange = (indexItem, indexSlider) => {
    const valLink = listThumbnail[indexSlider][indexItem].linkHref ?? '/';
  ...
  return /*#__PURE__*/_jsxs(Box, {
    ...
    }), !!listThumbnail?.length && /*#__PURE__*/_jsx(Box, {
      children: listThumbnail.map((rows, idx) => /*#__PURE__*/_jsxs(Box, {
        sx: {
            ...
            children: [/*#__PURE__*/_jsxs(Box, {
              ...
              children: [/*#__PURE__*/_jsx(Slider, _extends({}, settings, {
                ...
                children: rows.map((item, index) => /*#__PURE__*/_jsx(Box, {
                  onClick: () => thisSlider.current[idx]?.slickGoTo(index),
                  sx: {
                    maxWidth: {
              ...
              children: /*#__PURE__*/_jsx(Link, {
                href: listThumbnail[idx][0].linkHref ?? '/',
