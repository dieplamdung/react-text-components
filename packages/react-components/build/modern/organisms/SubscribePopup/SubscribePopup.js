...
const SubscribePopup = ({
  ...
  const IMG = {
    xs: imageLink?.xs || "https://i.ibb.co/kDmB61g/Image.png",
    md: imageLink?.md || "https://i.ibb.co/tCpRLxb/Image.png"
  };
    ...
    children: stepContent === 0 ? /*#__PURE__*/_jsx(Box, {
      ...
      children: /*#__PURE__*/_jsxs(Box, {
        ...
        children: [renderIconClose, /*#__PURE__*/_jsx(Typography, {
          ...
          children: contentModalSmall?.title || "Thanks for subscribing!"
        }), /*#__PURE__*/_jsx(Typography, {
          sx: {
            fontSize: "14px",
            lineHeight: {
          ...
          children: contentModalSmall?.label || "Look forward to exciting deals and news soon."
        }), /*#__PURE__*/_jsx(Box, {
          sx: {
            width: "100%",
            display: "flex",
          ...
          children: hrefNextPage ? /*#__PURE__*/_jsx(Button, {
            ...
            children: contentModalSmall?.labelBtn || 'See news and events'
