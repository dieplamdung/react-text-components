    ...
    children: [/*#__PURE__*/_jsx(Box, {
      children: /*#__PURE__*/_jsx(Box, {
        ...
        children: /*#__PURE__*/_jsx(Box, {
          ...
          children: mainImageNextProps?.(item?.image, item?.title) || /*#__PURE__*/_jsx("img", {
            src: item?.image,
            alt: item?.title || ""
          })
        })
      ...
      children: [item?.title && /*#__PURE__*/_jsx(Typography, {
        variant: "p3",
        sx: {
          color: colors.primary.bandaiNamcoBlack
        },
        children: item?.title
      }), item?.address && /*#__PURE__*/_jsx(Typography, {
        variant: "p6",
        sx: {
        ...
        children: !!item?.infoLink.length && item?.infoLink.map((itemLink, idx) => /*#__PURE__*/_jsx(Link, {
          href: itemLink?.href ?? '/',
          target: "_blank",
          sx: {
            textDecoration: 'none',
