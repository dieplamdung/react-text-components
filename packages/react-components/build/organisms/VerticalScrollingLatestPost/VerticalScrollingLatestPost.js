...
const VerticalScrollingLatestPost = props => {
  ...
  return /*#__PURE__*/_jsxs(Box, {
    children: [/*#__PURE__*/_jsx(Typography, {
      ...
      children: !!(dataListSplice != null && dataListSplice.length) && (dataListSplice == null ? void 0 : dataListSplice.map((child, idx) => /*#__PURE__*/_jsx(Box, {
        sx: {
          display: 'flex',
          flexWrap: 'wrap',
          gap: {
        ...
        children: !!(child != null && child.length) && (child == null ? void 0 : child.map((item, index) => /*#__PURE__*/_jsx(Box, {
          sx: {
            lineHeight: '0px',
            width: {
              xs: '100%',
