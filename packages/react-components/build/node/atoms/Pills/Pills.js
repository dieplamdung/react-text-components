...
const Pills = /*#__PURE__*/(0, _react.forwardRef)((props, ref) => {
  const {
    label,
    triggerClick = () => {},
    active,
  ...
  const [pillActive, setPillActive] = (0, _react.useState)(active);
  const theme = (0, _styles.useTheme)();
  const isMobile = (0, _material.useMediaQuery)(theme.breakpoints.down('md'));
  (0, _omit.default)(props, ['active']);
  ...
  return /*#__PURE__*/(0, _jsxRuntime.jsx)(_material.Box, {
    children: /*#__PURE__*/(0, _jsxRuntime.jsxs)(_material.Box, {
      ref: ref,
      children: [!iconMobile && /*#__PURE__*/(0, _jsxRuntime.jsx)(_material.Box, {
        sx: {
          display: 'inline-block',
          '& .active': {
            color: _colors.default.secondary.bandaiNamcoBlue,
            border: `1px solid ${_colors.default.secondary.bandaiNamcoBlue}`
          }
        },
        onClick: () => {
          triggerClick(label);
      ...
      }), iconMobile && numberFilter === 0 && /*#__PURE__*/(0, _jsxRuntime.jsx)(_material.Box, {
        className: pillActive ? 'active' : 'inactive',
        onClick: () => {
        ...
        children: /*#__PURE__*/(0, _jsxRuntime.jsx)(IConFilter, {})
      }), iconMobile && numberFilter > 0 && /*#__PURE__*/(0, _jsxRuntime.jsxs)(_material.Box, {
        sx: {
          borderRadius: '60px',
          padding: '11.5px 24px',
          display: 'inline-flex',
        ...
        children: [/*#__PURE__*/(0, _jsxRuntime.jsx)(IConFilterActive, {}), /*#__PURE__*/(0, _jsxRuntime.jsx)(_Typography.default, {
          variant: "p7",
          color: _colors.default.primary.bandaiNamcoBlack,
          sx: {
            paddingLeft: '6px',
