        ...
        (0, _extends2.default)({}, buttonProps, {
          sx: {
            backgroundColor: isButtonSecond
              ? _colors.default.primary.reactNamcoWhite
              : _colors.default.primary.reactNamcoRed,
            color: isButtonSecond
              ? _colors.default.primary.reactNamcoBlack
              : _colors.default.primary.reactNamcoWhite,
            padding: {
              xs: '8px 48px 12px',
              md: '10px 46.5px 14px',
            ...
            '&:hover': {
              backgroundColor: isButtonSecond
                ? _colors.default.primary.reactNamcoWhite
                : _colors.default.accent.accentRed[1],
              color: isButtonSecond
                ? _colors.default.accent.accentRed[1]
                : _colors.default.primary.reactNamcoWhite,
            },
        ...
        children: [
          ...
          /*#__PURE__*/ (0, _jsxRuntime.jsxs)(_Typography.default, {
            ...
            children: [
              ...
              !priceProps.noFormat
                ? (0, _utils.formatCurrency)(
                    Number(priceProps == null ? void 0 : priceProps.amount) || 0,
                    2,
                  )
                : priceProps == null
                ? void 0
