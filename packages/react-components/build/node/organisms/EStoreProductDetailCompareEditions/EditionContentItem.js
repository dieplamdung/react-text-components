...
exports.default = EditionContentItem;
...
function EditionContentItem(props) {
  ...
  const Item = _svg || (_svg = /*#__PURE__*/(0, _jsxRuntime.jsx)("svg", {
    width: "24",
    height: "24",
    viewBox: "0 0 24 24",
    fill: "none",
  ...
  const ItemMobile = _svg2 || (_svg2 = /*#__PURE__*/(0, _jsxRuntime.jsx)("svg", {
    width: "16",
    height: "16",
    viewBox: "0 0 16 16",
    fill: "none",
  ...
  return /*#__PURE__*/(0, _jsxRuntime.jsxs)(_system.Box, {
    ...
    }), !!(listShowEdition != null && listShowEdition.length) && listShowEdition.map((item, index) => {
      return /*#__PURE__*/(0, _jsxRuntime.jsxs)(_system.Box, {
        sx: {
          width: {
            xs: "110px",
