...
// import Modules
// import Styles
const PlayVideo = /*#__PURE__*/(0, _react.forwardRef)((props, ref) => {
  const {
    idVideo,
    title,
    className,
  ...
  const refVideo = (0, _react.useRef)(); // const [autoPlay, setAutoPlay] = useState<boolean>(false);
  // const [usePlayVideo, setPlayVideo] = useState<boolean>(false)
  // const matches = useMediaQuery('(max-width:1024px)', { noSsr: true });

  const matchesSmallMobile = (0, _material.useMediaQuery)('(max-width:321px)', {
    noSsr: true
  });
  const matchesMinWidthSmallMobile = (0, _material.useMediaQuery)('(min-width:321px)', {
    noSsr: true
  });
  const matchesMinWidthSmallTable = (0, _material.useMediaQuery)('(min-width:991px)', {
    noSsr: true
  }); // const imageVideo = `https://img.youtube.com/vi/${idVideo}/hqdefault.jpg`;

  const refTimOut = (0, _react.useRef)();
  const newTypeVideo = typeVideo == null ? void 0 : typeVideo.toLowerCase();
  /**
  ...
  const videoMemoIframe = (0, _react.useMemo)(() => /*#__PURE__*/(0, _jsxRuntime.jsx)(_Box.default, {
...
var _default = /*#__PURE__*/_react.default.memo(PlayVideo);
