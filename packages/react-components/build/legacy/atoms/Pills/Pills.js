...
var Pills = /*#__PURE__*/forwardRef(function (props, ref) {
  var label = props.label,
      _props$triggerClick = props.triggerClick,
      triggerClick = _props$triggerClick === void 0 ? function () {} : _props$triggerClick,
      active = props.active,
      _props$iconMobile = props.iconMobile,
      iconMobile = _props$iconMobile === void 0 ? false : _props$iconMobile,
      _props$numberFilter = props.numberFilter,
      numberFilter = _props$numberFilter === void 0 ? 0 : _props$numberFilter;

  var _useState = useState(active),
      _useState2 = _slicedToArray(_useState, 2),
      pillActive = _useState2[0],
      setPillActive = _useState2[1];

  var theme = useTheme();
  var isMobile = useMediaQuery(theme.breakpoints.down('md'));
  omit(props, ['active']);

  var IConFilter = function IConFilter(prop) {
  ...
  useImperativeHandle(ref, function () {
    return {
      handleResetActive: function handleResetActive() {
        setPillActive(false);
      },
      handleSetActivePill: function handleSetActivePill() {
        setPillActive(true);
      }
    };
  });

  var IConFilterActive = function IConFilterActive(prop) {
    return /*#__PURE__*/_jsx("svg", _extends({
      width: "14",
      height: "14",
      viewBox: "0 0 14 14",
      ...
      children: [!iconMobile && /*#__PURE__*/_jsx(Box, {
        sx: {
          ...
          '& .active': {
            ...
            border: "1px solid ".concat(colors.secondary.bandaiNamcoBlue)
          }
        },
