...
var Tags = function Tags(_ref) {
  var color = _ref.color,
      ...
      _ref$hoverPermission = _ref.hoverPermission,
      hoverPermission = _ref$hoverPermission === void 0 ? true : _ref$hoverPermission;
  return /*#__PURE__*/_jsx(Box, {
    sx: {
      ...
      '& p': {
        ...
        position: 'relative',
        borderRadius: '5px',
        border: showBackground ? "1px solid transparent" : "1px solid ".concat(color)
      },
      '& .bgTag': {
        transition: 'all .4s'
      }
    ...
    children: title && /*#__PURE__*/_jsxs(Box, {
      ...
      children: [/*#__PURE__*/_jsx(Typography, {
        ...
        sx: {
          ...
          opacity: disabled ? 1 : "".concat(showBackground ? '10%' : "0"),
          position: 'absolute',
          top: '0px',
          bottom: '0px',
          left: '0px',
