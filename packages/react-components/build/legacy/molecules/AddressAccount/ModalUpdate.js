...
export default function ModalUpdate(props) {
  ...
  var _useState3 = useState(''),
      ...
      countryNumber = _useState4[0],
      setCountryNumber = _useState4[1];

  var _useState5 = useState(""),
      _useState6 = _slicedToArray(_useState5, 2),
      countryDefault = _useState6[0],
      setCountryDefault = _useState6[1];

  var _useState7 = useState(""),
      _useState8 = _slicedToArray(_useState7, 2),
      errorApi = _useState8[0],
      setErrorApi = _useState8[1];
  ...
  var _useState11 = useState([]),
      ...
      setCountryList = _useState12[1];

  var _useState13 = useState([]),
      _useState14 = _slicedToArray(_useState13, 2),
      countryListCode = _useState14[0],
      setCountryListCode = _useState14[1];
  ...
  var handleSave = function handleSave() {
    ...
    var newValue = {
      ...
      phone: "".concat(countryNumber, " ").concat(value[((_template$phoneNumber = template.phoneNumber) == null ? void 0 : _template$phoneNumber.title) || ""]),
      company: value[((_template$company = template.company) == null ? void 0 : _template$company.title) || ""]
    };
    onSave(newValue, function (v) {
      setLoading(false);
        ...
        children: [/*#__PURE__*/_jsx(Box, {
          ...
          children: [/*#__PURE__*/_jsx(Box, {
            ...
            children: /*#__PURE__*/_jsx(TextField, _extends({
              ...
              required: "".concat(template == null ? void 0 : (_template$firstName8 = template.firstName) == null ? void 0 : _template$firstName8.messageEmpty) // onBlur: () => {handelBlurInput(getValues())},
            ...
            children: /*#__PURE__*/_jsx(TextField, _extends({
              ...
              required: "".concat(template == null ? void 0 : (_template$lastName8 = template.lastName) == null ? void 0 : _template$lastName8.messageEmpty) // onBlur: () => {handelBlurInput(getValues())},
            ...
            children: /*#__PURE__*/_jsx(TextField, _extends({
              ...
              required: "".concat(template == null ? void 0 : (_template$address8 = template.address) == null ? void 0 : _template$address8.messageEmpty) // onBlur: () => {handelBlurInput(getValues())},
