...
var KeyFeature = function KeyFeature(props) {
  var title = props.title,
      descriptionTop = props.descriptionTop,
      descriptionBottom = props.descriptionBottom,
      image = props.image,
      _props$imagePosition = props.imagePosition,
      imagePosition = _props$imagePosition === void 0 ? "right" : _props$imagePosition,
      _props$typeBorder = props.typeBorder,
      typeBorder = _props$typeBorder === void 0 ? "waves" : _props$typeBorder;
  var shapes = {
  ...
  var renderPaddingBottomHeightMobile = function renderPaddingBottomHeightMobile() {
  ...
  var renderMaxWidth = function renderMaxWidth() {
    if (typeBorder === "oval") {
      return "335px";
    }
      ...
      children: [/*#__PURE__*/_jsx(Box, {
        ...
        children: /*#__PURE__*/_jsx(Box, {
          sx: {
            ...
            maskImage: typeBorder !== "none" ? "url(".concat(shapes == null ? void 0 : shapes["".concat(typeBorder)], ")") : 'none',
