...
var PlayVideo = /*#__PURE__*/forwardRef(function (props, ref) {
  var idVideo = props.idVideo,
      title = props.title,
      className = props.className,
      disable = props.disable,
      index = props.index,
      selectedTrailer = props.selectedTrailer,
      _props$typeVideo = props.typeVideo,
      typeVideo = _props$typeVideo === void 0 ? "youtube" : _props$typeVideo,
      indexBeforeChange = props.indexBeforeChange;
  var refVideo = useRef(); // const [autoPlay, setAutoPlay] = useState<boolean>(false);
  // const [usePlayVideo, setPlayVideo] = useState<boolean>(false)
  // const matches = useMediaQuery('(max-width:1024px)', { noSsr: true });

  var matchesSmallMobile = useMediaQuery('(max-width:321px)', {
    noSsr: true
  });
  var matchesMinWidthSmallMobile = useMediaQuery('(min-width:321px)', {
    noSsr: true
  });
  var matchesMinWidthSmallTable = useMediaQuery('(min-width:991px)', {
    noSsr: true
  }); // const imageVideo = `https://img.youtube.com/vi/${idVideo}/hqdefault.jpg`;

  var refTimOut = useRef();
  var newTypeVideo = typeVideo == null ? void 0 : typeVideo.toLowerCase();
  /**
  ...
  useImperativeHandle(ref, function () {
    return {
      handleResetVideoOnchange: function handleResetVideoOnchange() {}
    };
  }); // eslint-disable-next-line consistent-return

  var handleUpdateWidthIframe = function handleUpdateWidthIframe() {
  ...
  useEffect(function () {
    ...
    refTimOut.current = setTimeout(function () {
      ...
      var wrapperContent = document.querySelector(".".concat(className));

      if (wrapperContent && newTypeVideo === "youtube") {
        var iframes = wrapperContent.querySelectorAll('iframe');
      ...
      if (wrapperContent) {
        var videos = wrapperContent.querySelectorAll('iframe, video');
  ...
  var renderIframeVideo = function renderIframeVideo(classVD, idVideoVd, titleVD) {
    switch (newTypeVideo) {
      case "vimeo":
        return /*#__PURE__*/_jsx("iframe", {
          title: title || "",
          loading: "lazy",
          src: "https://player.vimeo.com/video/".concat(idVideoVd, "?h=3a3669479e&color=ffffff&title=0&byline=0&portrait=0"),
          frameBorder: "0",
      ...
      case "bilibili":
        return /*#__PURE__*/_jsx("iframe", {
          ...
          src: "//player.bilibili.com/player.html?aid=".concat(idVideoVd, "&bvid=").concat(idVideoVd, "&cid=839966468&page=1"),
          scrolling: "no",
          frameBorder: "no",
          title: title || ""
        });
      ...
      default:
        return /*#__PURE__*/_jsx("iframe", {
          ...
          width: "100%",
          height: "100%",
          src: "https://www.youtube.com/embed/".concat(idVideoVd, "?autoplay=0&enablejsapi=1&start=1"),
          title: titleVD,
          frameBorder: "0",
          allow: "accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture",
          allowFullScreen: true
  ...
  var videoMemoIframe = useMemo(function () {
