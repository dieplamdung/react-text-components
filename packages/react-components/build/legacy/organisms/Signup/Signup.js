...
var Signup = function Signup(props) {
  ...
  var mainImage = props.mainImage,
      ...
      firstNameField = props.firstNameField,
      lastNameField = props.lastNameField,
      emailField = props.emailField,
      passwordField = props.passwordField,
      acceptNewsCheckbox = props.acceptNewsCheckbox,
      policyAndTerms = props.policyAndTerms,
      signupButton = props.signupButton,
      loginLink = props.loginLink,
      nextLink = props.nextLink,
      _props$openPopupSucce = props.openPopupSuccessful,
      openPopupSuccessful = _props$openPopupSucce === void 0 ? false : _props$openPopupSucce,
      onClose = props.onClose,
      popupSuccessful = props.popupSuccessful,
      _props$onSubcribe = props.onSubcribe,
      onSubcribe = _props$onSubcribe === void 0 ? function () {} : _props$onSubcribe,
      errorEmailMessage = props.errorEmailMessage;
  ...
  var _useState7 = useState(true),
      ...
      validateNotPassed = _useState8[0],
      setValidateNotPassed = _useState8[1];
  ...
  var _useState11 = useState(openPopupSuccessful),
      ...
      children: /*#__PURE__*/_jsx(Box, {
        ...
        children: /*#__PURE__*/_jsxs(Box, {
          ...
          children: [renderIconClose, /*#__PURE__*/_jsx(Box, {
            ...
            children: popupSuccessful == null ? void 0 : popupSuccessful.button.map(function (item, index) {
          ...
          children: [/*#__PURE__*/_jsxs(Box, {
            ...
            children: [/*#__PURE__*/_jsx(Box, {
              children: /*#__PURE__*/_jsx(TextField, _extends({
                ...
                required: "".concat(firstNameField == null ? void 0 : firstNameField.emptyField),
              ...
              children: /*#__PURE__*/_jsx(TextField, _extends({
                ...
                required: "".concat(lastNameField == null ? void 0 : lastNameField.emptyField),
                onBlur: function onBlur(e) {
                  if (!e.target.value) {
                    setError('lastName', {
                      type: 'string',
              ...
              children: /*#__PURE__*/_jsx(TextField, _extends({}, passwordField, {
                ...
                onBlur: function onBlur(e) {
                  ...
                  if (validateNotPassed) {
                    setError('password', {
                      type: 'string',
                      message: "".concat(passwordField == null ? void 0 : passwordField.helperText)
                    });
                    e.preventDefault();
                  }
                  ...
                  if (!password) {
                    setError('password', {
                      type: 'string',
                      message: "".concat(passwordField == null ? void 0 : passwordField.emptyField)
                    });
                    e.preventDefault();
                  }
                },
            ...
            children: /*#__PURE__*/_jsxs(Typography, {
              ...
              children: [policyAndTerms == null ? void 0 : policyAndTerms.text, "\xA0", /*#__PURE__*/_jsx(Link, {
            ...
            children: /*#__PURE__*/_jsx(Button, _extends({}, signupButton, {
              ...
              type: "submit",
              sx: {
                backgroundColor: loadingSubmit || successful ? "".concat(colors.primary.bandaiNamcoRed, " !important") : '',
                color: successful ? "".concat(colors.primary.bandaiNamcoWhite, " !important") : '',
                '& svg': {
              ...
              label: loadingSubmit && (_IconLoading || (_IconLoading = /*#__PURE__*/_jsx(IconLoading, {}))) || (signupButton == null ? void 0 : signupButton.label)
            }))
          }), /*#__PURE__*/_jsx(Box, {
            sx: {
              width: '100%',
            ...
            children: /*#__PURE__*/_jsxs(Typography, {
              ...
              children: [loginLink == null ? void 0 : loginLink.text, "\xA0", nextLink || /*#__PURE__*/_jsx(Link, {
