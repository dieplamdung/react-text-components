...
var GameDetailMasthead = function GameDetailMasthead(props) {
  var _VideoPopupSlider;

  var mastheadTitle = props.mastheadTitle,
      mastheadBgAsset = props.mastheadBgAsset,
      mastheadBgEmbed = props.mastheadBgEmbed,
      _props$videoType = props.videoType,
      videoType = _props$videoType === void 0 ? 'youtube' : _props$videoType,
      mastheadDesc = props.mastheadDesc,
      platforms = props.platforms,
      ipPublisher = props.ipPublisher,
      price = props.price,
      fromPricing = props.fromPricing,
      currency = props.currency,
      ctaButtonText = props.ctaButtonText,
      trailersRaw = props.trailers,
      externalLink = props.externalLink,
      locale = props.locale,
      mainImageNext = props.mainImageNext,
      _props$videoDirectly = props.videoDirectly,
      videoDirectly = _props$videoDirectly === void 0 ? false : _props$videoDirectly;
  ...
  var _useState = useState(0),
      ...
      setSelectedTrailer = _useState2[1];

  var trailerThumbnailRef = /*#__PURE__*/React.createRef();
  var desktopTrailerSliderRef = /*#__PURE__*/React.createRef();
  ...
  var trailerRef = useRef();

  var _useState5 = useState("100vh"),
      _useState6 = _slicedToArray(_useState5, 2),
      heightMasthead = _useState6[0],
      setHeightMasthead = _useState6[1];
  /**
  ...
  useEffect(function () {
    if (typeof window !== "undefined") {
      var container = trailerThumbnailRef.current;
    ...
    return function () {
      ...
      window.removeEventListener("null", function () {});
    };
  }, [trailerThumbnailRef]);
  /**
  ...
  var trailerItems = trailersRaw.filter(function (trailer) {
    return trailer.trailerUrl;
  });
  /**
  ...
  var remapTrailerItems = useMemo(function () {
    return trailerItems == null ? void 0 : trailerItems.map(function (item) {
  ...
  var handleOpenPopup = function handleOpenPopup(result) {
    setOpenPopup(result);
  };

  var ctaButtonHandler = function ctaButtonHandler() {// To be implemented
    ...
    return /*#__PURE__*/_jsxs(Stack, {
      ...
      children: [/*#__PURE__*/_jsx(Box, {
        ...
        children: [/*#__PURE__*/_jsx(Typography, {
          ...
          children: platforms.map(function (platform, i) {
            return typeof platform === 'string' ? /*#__PURE__*/_jsx(PlatformPill, {
              platform: platform
            }, i) : /*#__PURE__*/_jsx(Box, {
              sx: {
          ...
          '& .slider.mobile-slider': {
            ...
            '& .slick-dots': {
              '& li': {
                ...
                '&:hover': {
                  '& button:before': {
                    color: "".concat(colors.primary.bandaiNamcoRed, " !important")
                  }
                }
              },
              '& li.slick-active': {
          ...
          children: trailerItems == null ? void 0 : trailerItems.map(function (trailerInfo, i) {
            return /*#__PURE__*/_jsxs(Box, {
              ...
              children: [/*#__PURE__*/_jsx(Box, {
                ...
                children: (trailerInfo == null ? void 0 : trailerInfo.nextImage) || /*#__PURE__*/_jsx("img", {
  ...
  var handleRenderIframe = function handleRenderIframe(typeVideo, mastheadBgID) {
    switch (typeVideo) {
      ...
      case 'bilibili':
        return "//player.bilibili.com/player.html?aid=".concat(mastheadBgID, "&bvid=").concat(mastheadBgID, "&cid=839966468&page=1");
  ...
  return /*#__PURE__*/_jsxs(Stack, {
    ...
    sx: {
      position: 'relative',
      minHeight: "".concat(heightMasthead),
      paddingBottom: '52px',
      overflow: 'hidden',
