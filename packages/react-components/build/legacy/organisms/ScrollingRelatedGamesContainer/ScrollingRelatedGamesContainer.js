  ...
  useEffect(function () {
    if (typeof window !== "undefined") {
      ...
      window.addEventListener("resize", function () {
        ...
        refLastChild.current.style.marginLeft = "".concat(((_refContainer$current3 = refContainer.current) == null ? void 0 : _refContainer$current3.offsetLeft) + (refIsMobileMin.current ? 16 : 24), "px"); // set width item
    ...
    children: [/*#__PURE__*/_jsx(Container, {
      ...
      children: /*#__PURE__*/_jsxs(Box, {
        ...
        children: [title && /*#__PURE__*/_jsx(Typography, {
          ...
          }), !isTabletDown && (isDesktop ? (listThumbnail == null ? void 0 : listThumbnail.length) > 3 : (listThumbnail == null ? void 0 : listThumbnail.length) > 2) && /*#__PURE__*/_jsxs(Box, {
            sx: {
              display: 'flex',
              alignItems: 'center',
              marginLeft: '48px'
