...
function ContentOrderList(props) {
  var listOrder = props.listOrder,
      propsButton = props.propsButton,
      titleOrderEmpty = props.titleOrderEmpty,
      descriptionOrderEmpty = props.descriptionOrderEmpty,
  ...
  return /*#__PURE__*/_jsxs(Box, {
    ...
    }), !!(listOrder != null && listOrder.length) && listOrder.map(function (order, index) {
