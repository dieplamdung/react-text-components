...
export var WrapperContainer = function WrapperContainer(child) {
...
export default function Option(props) {
  ...
  var tabList = props.tabList,
      ...
      itemPlatformSelect = props.itemPlatformSelect,
      itemTypeSelect = props.itemTypeSelect,
      itemSelectEdition = props.itemSelectEdition,
      typeOption = props.typeOption,
      typeEdition = props.typeEdition,
      onSelectPlatform = props.onSelectPlatform,
      onSelectType = props.onSelectType,
      onSelectEdition = props.onSelectEdition,
      buttonPropsAddCart = props.buttonPropsAddCart,
      buttonPropsBuyNow = props.buttonPropsBuyNow,
      maxQuantity = props.maxQuantity,
      quantity = props.quantity,
      onSelectQty = props.onSelectQty,
      labelQty = props.labelQty,
      price = props.price,
      buttonPropsBuyNowDigital = props.buttonPropsBuyNowDigital,
      isSelectTypeDigital = props.isSelectTypeDigital,
  ...
  return /*#__PURE__*/_jsxs(Box, {
    ...
    children: [WrapperContainer( /*#__PURE__*/_jsxs(React.Fragment, {
      ...
      children: [WrapperContainer( /*#__PURE__*/_jsx(Typography, {
        ...
        ref: refWrapper,
        children: [!!(platform != null && (_platform$platformLis = platform.platformList) != null && _platform$platformLis.length) && (platform == null ? void 0 : platform.platformList.map(function (item, index) {
            ...
            children: /*#__PURE__*/_jsx(Box, {
              ...
              children: /*#__PURE__*/_jsx(Platform, {
                ...
                onClick: function onClick() {
                  return onSelectPlatform == null ? void 0 : onSelectPlatform(item);
                }
              })
            })
          }, index);
        ...
        children: [/*#__PURE__*/_jsx(Box, {
          ...
          children: /*#__PURE__*/_jsx(DropdownQuantity, {
            ...
            onSetQuantity: function onSetQuantity(qty) {
              return onSelectQty == null ? void 0 : onSelectQty(qty);
            }
          })
        }), /*#__PURE__*/_jsx(Typography, {
          variant: "h6",
