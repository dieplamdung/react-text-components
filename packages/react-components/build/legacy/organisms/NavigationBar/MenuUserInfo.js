...
var MenuUserInfo = /*#__PURE__*/React.forwardRef(function (props, ref) {
  var handleCloseMenuUserInfo = props.handleCloseMenuUserInfo,
      handleCloseAllMenu = props.handleCloseAllMenu,
      account = props.account,
      details = props.details,
      orders = props.orders,
      address = props.address,
      logout = props.logout,
      _props$isRelative = props.isRelative,
      isRelative = _props$isRelative === void 0 ? false : _props$isRelative,
    ...
    children: [/*#__PURE__*/_jsxs(Box, {
      ...
      children: [/*#__PURE__*/_jsx(IconPrevSlide, {
        ...
        onClick: function onClick() {
          return handleCloseMenuUserInfo();
        }
      }), /*#__PURE__*/_jsx(Box, {
        onClick: function onClick() {
          return handleCloseAllMenu();
        },
