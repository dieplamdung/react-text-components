...
var LocaleCardInfo = function LocaleCardInfo(props) {
  var item = props.item,
      mainImageNextProps = props.mainImageNextProps;

  var IconNext = _svg || (_svg = /*#__PURE__*/_jsx("svg", {
    width: "5.5",
    height: "10",
    viewBox: "0 0 6 11",
    fill: "none",
  ...
  return /*#__PURE__*/_jsxs(Box, {
    children: [/*#__PURE__*/_jsx(Box, {
      ...
      children: [(item == null ? void 0 : item.title) && /*#__PURE__*/_jsx(Typography, {
        ...
        children: !!(item != null && item.infoLink.length) && (item == null ? void 0 : item.infoLink.map(function (itemLink, idx) {
          var _itemLink$href;
