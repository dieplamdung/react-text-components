...
var CardGame = function CardGame(_ref) {
  var nextImage = _ref.nextImage,
      title = _ref.title,
      image = _ref.image,
      href = _ref.href,
  ...
  var handleActiveLink = function handleActiveLink(e) {
  ...
  return /*#__PURE__*/_jsxs(Box, {
    sx: {
      width: {
        xs: isHomePage ? "171px" : "".concat(isEven ? "171px" : "100px"),
        md: isHomePage ? "358px" : "".concat(isEven ? "358px" : "209px")
      },
      height: {
        xs: "100px",
        md: "209px"
