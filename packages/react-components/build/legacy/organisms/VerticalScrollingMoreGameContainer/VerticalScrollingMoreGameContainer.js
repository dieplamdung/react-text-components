...
var VerticalScrollingMoreGameContainer = function VerticalScrollingMoreGameContainer(_ref) {
  var title = _ref.title,
      _ref$notFilter = _ref.notFilter,
      notFilter = _ref$notFilter === void 0 ? true : _ref$notFilter,
      onLoadMore = _ref.onLoadMore,
      dataItem = _ref.dataItem,
      _ref$nextPage = _ref.nextPage,
      nextPage = _ref$nextPage === void 0 ? true : _ref$nextPage,
      dataTranslation = _ref.dataTranslation;
  ...
  var _React$useState = React.useState(true),
      ...
      hasNextPage = _React$useState2[0],
      setHasNextPage = _React$useState2[1];
  ...
  return /*#__PURE__*/_jsxs(Box, {
    ...
    children: [title && /*#__PURE__*/_jsx(Typography, {
      ...
      children: /*#__PURE__*/_jsx(Grid, {
        ...
        children: !!(items != null && items.length) && items.map(function (listingCard, index) {
