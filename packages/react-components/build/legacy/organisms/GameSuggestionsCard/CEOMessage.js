...
// define function
var CEOMessage = function CEOMessage(_ref) {
  var isOpen = _ref.isOpen,
      _onClose = _ref.onClose,
      name = _ref.name,
      position = _ref.position,
      contentMsg = _ref.contentMsg;
  var renderIconClose = useMemo(function () {
    return /*#__PURE__*/_jsx(IconClose, {
      ...
      onClick: function onClick() {
        return _onClose == null ? void 0 : _onClose(false);
      }
    });
  }, [_onClose]);
  useEffect(function () {
    ...
    children: /*#__PURE__*/_jsx(Box, {
      ...
      children: /*#__PURE__*/_jsxs(Box, {
        ...
        children: [renderIconClose, /*#__PURE__*/_jsxs(Box, {
          children: [(contentMsg == null ? void 0 : contentMsg.title) && /*#__PURE__*/_jsx(Typography, {
            variant: "h4",
            sx: {
