...
function ProductItem(props) {
  ...
  var tabList = props.tabList,
      ...
      href = props.href,
      _props$hrefImg = props.hrefImg,
      hrefImg = _props$hrefImg === void 0 ? "" : _props$hrefImg,
      _props$isDLC = props.isDLC,
      isDLC = _props$isDLC === void 0 ? false : _props$isDLC,
      titleDLC = props.titleDLC,
      _props$listIcon = props.listIcon,
      listIcon = _props$listIcon === void 0 ? [] : _props$listIcon,
      language = props.language,
      titleGame = props.titleGame,
      titleFrom = props.titleFrom,
      price = props.price,
      priceOld = props.priceOld,
      _props$isShowBottom = props.isShowBottom,
      isShowBottom = _props$isShowBottom === void 0 ? false : _props$isShowBottom;

  var returnTitle = function returnTitle() {
  ...
  return /*#__PURE__*/_jsxs(Box, {
    ...
    children: [/*#__PURE__*/_jsx(Tabs, {
      ...
      children: listIcon == null ? void 0 : listIcon.map(function (item, index) {
